...
public enum InterruptibleRunnableState {
    ...
    /**
     * The canceled state of the process. A process which terminates because of
     * a cancel call will remain with status CANCELED until started again. A
     * process which finish normally should move to NOT_RUNNING state.
     */
    CANCELED
